                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>@if($item->Verifikasi >0)<div class="badge badge-success">Terverifikasi</div>
                      ...
                      @endif</td>
                    <td>
                      {{-- <a href=""><button type="button" class="btn btn-primary btn-sm" name=""> <i class="fa fa-edit"></i></button></a> --}}
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="JumlahPajak" id="JumlahPajak" class="form-control" placeholder="Nilai Pajak" >
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Satuan</label>
                          <input Value="Bulan/ Tahun" type="text" class="form-control" disabled>
                        </div>
                      </div>
                    </div>
                    <!-- input states -->
